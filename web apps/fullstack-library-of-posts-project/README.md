# Fullstack pet-проект "Библиотека постов(запись, состоящая из названия и содержания)" - Vue 3: SPA + Spring Boot: CRUD REST API, с постраничным выводом постов (пагинацией) и возможностями 
